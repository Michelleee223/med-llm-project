document.addEventListener('DOMContentLoaded', function() {
    ...
    imageInput.addEventListener('change', function(e) {
        if (e.target.files && e.target.files[0]) {
            ...
            reader.onload = function(event) {
                ...
                imageInputLabel.classList.add('has-image');
            };
    ...
    removeImageBtn.addEventListener('click', function() {
        ...
        imageInputLabel.classList.remove('has-image');
    });
    ...
    function convertMarkdownToHtml(markdown) {
        ...
        html = html.replace(/(<li>[\s\S]*?<\/li>)(?![\s\S]*<\/ul>)(?![\s\S]*<\/ol>)/g, '<ol>$1</ol>');
    ...
    function displayServerResponse(response) {
        ...
        bubble.appendChild(recommendationSection);
        messageDiv.appendChild(bubble);
        chatContainer.appendChild(messageDiv);
        scrollToBottom();
    }
